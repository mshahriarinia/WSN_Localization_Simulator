package algorithms.dv.sysEqSolver.jama;
...
public class CholeskyDecomposition implements java.io.Serializable {
	 ...
	 * definite matrix A, the Right Cholesky decomposition is an upper
	 * triangular matrix R so that A = R'R. This constructor computes R with the
	 * Fortran inspired column oriented algorithm used in LINPACK and MATLAB. In
	 * Java, we suspect a row oriented, lower triangular decomposition is
	 * faster. We have temporarily included this constructor here until timing
	 * experiments confirm this suspicion.\
	 * 
	 ...
	 * } R[k][j] = s = s/R[k][k]; d = d + ss; isspd = isspd & (A[k][j] ==
